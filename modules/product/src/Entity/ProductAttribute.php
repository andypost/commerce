 ...
 *     "edit-form" = "/admin/commerce/product-attributes/{commerce_product_attribute}/edit",
 *     "delete-form" = "/admin/commerce/product-attributes/{commerce_product_attribute}/delete",
 *     "overview-form" = "/admin/commerce/product-attributes/{commerce_product_attribute}/delete",
